...
#
# Please see the README.md or README.pdf document for more details on the inner-workings of this module. 

''' Quick Overview
CommentCounter needs to be initiated with a file name. If the filename is invalid, 
...
"""  ------CommentCounter Expansion------

Class:
@CommentCounter:       This class will hold functions to allow code analysis to determine
...
@requirements:          extensions.py only. It has important configurations for the
                        CommentCounter class file extension support and useage.
...
class CommentCounter(object):
    ...
    def comment_single(self, comment_syntax):
        ...
        # Note: I used ISO-8859-1 encoding to avoid UnicodeDecodeErrors
        with open(self.filename, 'r', encoding='ISO-8859-1') as active_file:
            bool_active_block = False  # To keep track if we're currently in an active block
